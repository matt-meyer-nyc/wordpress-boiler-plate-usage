...
class Rocket_Books {
	...
	/**
	 * Define all action and fileter hooks for registering custom post types
	 */
	...
	public function define_post_type_hooks() {
		...
		// 3rd argument init function defined in /includes/classic-rocket'books-post-types.php
